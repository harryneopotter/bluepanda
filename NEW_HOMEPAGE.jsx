// NEW REDESIGNED HOMEPAGE - Review this before replacing
// This goes in the HomePage component (lines 320-401 in App.jsx)

const HomePage = ({ navigate }) => (
    <div className="relative min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300 overflow-hidden">
        {/* Animated mesh gradient background */}
        <div className="fixed inset-0 mesh-gradient opacity-60 dark:opacity-40 pointer-events-none" />
            ...
            <FadeIn>
                <div className="grid md:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="md:col-span-7 space-y-8">
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-xl font-medium">
        ...
        <Section className="relative">
            <FadeIn delay={200}>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {/* Q Panda Cloud - Blue */}
                    <div className="group relative p-8 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/20 rounded-3xl border-2 border-blue-200 dark:border-blue-800 overflow-hidden transition-all duration-500 hover:scale-105 hover:-rotate-1">
                        ...
                        <div className="relative z-10">
                            <div className="w-16 h-16 bg-blue-600 dark:bg-blue-500 rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform duration-300">
                    ...
                    <div className="group relative p-8 bg-gradient-to-br from-gray-900 to-purple-900 dark:from-black dark:to-purple-950 rounded-3xl border-2 border-purple-500 overflow-hidden transition-all duration-500 hover:scale-105 neon-glow-purple">
                    ...
                    <div className="group relative p-8 bg-gradient-to-br from-teal-50 to-teal-100 dark:from-teal-950/30 dark:to-teal-900/20 rounded-3xl border-2 border-teal-200 dark:border-teal-800 overflow-hidden transition-all duration-500 hover:scale-105 hover:rotate-1">
                        <div className="absolute bottom-0 left-0 w-32 h-32 bg-teal-500/20 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-700" />
                        <div className="relative z-10">
                            <div className="w-16 h-16 bg-teal-600 dark:bg-teal-500 rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform duration-300">
        ...
        <Section className="py-16">
            <FadeIn delay={400}>
                <div className="flex flex-wrap justify-center items-center gap-12 text-gray-600 dark:text-gray-400">
                    ...
                    <div className="flex items-center gap-3 group">
                        <Activity className="w-6 h-6 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform" />
                        <span className="font-bold text-lg">Since 2013</span>
                    </div>
                    <div className="flex items-center gap-3 group">
                        <Globe className="w-6 h-6 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform" />
