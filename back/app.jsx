  ...
  <PageWrapper>
    <div className="relative min-h-screen bg-void text-white overflow-hidden">
      ...
      >
        ...
        <motion.h1 variants={fadeInUp} className="text-5xl md:text-8xl font-bold mb-6 tracking-tight leading-none">
        ...
        <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-gray-300 max-w-2xl mb-12 font-mono">
